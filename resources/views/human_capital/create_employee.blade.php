                ...
                <section id="personal-data" class="mb-4">
                    ...
                    <div class="row mb-3">
                        <div class="col-md-7 col-12 mb-md-0 mb-3">
                            ...
                            <input type="email" class="form-control" id="email" name="email" value="{{ old('email') }}" placeholder="johndoe@gmail.com">
                            @error('email')
                                <div class="text-danger mt-2">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="col-md-5 col-12">
                            ...
                            <input type="text" class="form-control" id="nomor_hp" name="nomor_hp" value="{{ old('nomor_hp') }}" placeholder="08*****">
                            @error('nomor_hp')
                                <div class="text-danger mt-2">
                                    {{ $message }}
                                </div>
                    ...
                    <div class="row mb-3">
                        <div class="col-md-7 col-12 mb-md-0 mb-3">
                            ...
                            <input type="text" class="form-control" id="tempat_lahir" name="tempat_lahir" value="{{ old('tempat_lahir') }}" placeholder="Jakarta">
                            @error('tempat_lahir')
                                <div class="text-danger mt-2">
                                    {{ $message }}
                                </div>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" name="alamat" id="alamat" rows="3" placeholder="Jl. Teratai No. 2, Pasar Minggu, Jakarta Selatan">{{ old('alamat') }}</textarea>
                        @error('alamat')
                            <div class="text-danger mt-2">
                                {{ $message }}
                            </div>
