...
<ol class="breadcrumb my-4">
        ...
        <li class="breadcrumb-item active"><small>Update Data Pencairan</small></li>
    </ol>
    <hr class="mb-4">
    <div class="d-md-flex d-block justify-content-between align-items-center mb-5">
        <h4 class="fw-bold mb-md-0 mb-2">Update Data Pencairan</h4>
    </div>
    <div class="row mb-5">
        <div class="col-lg-7 col-12">
            <form action="{{ Route('pencairan.update', $pencairan->id) }}" method="POST"  enctype="multipart/form-data">
                @csrf
                {{ method_field('PUT') }}
                  <section id="personal-data" class="mb-4">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="id_pengajuan" name="id_pengajuan" value="{{ $pencairan->id_pengajuan}}" placeholder="ID pengajuan" readonly>
                        @error('id_pengajuan')
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="jml_dana_keluar" name="jml_dana_keluar"  value="{{ $pencairan->jml_dana_keluar}}" placeholder="Rp. 45.0000">
